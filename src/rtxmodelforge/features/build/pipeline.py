...
from rtxmodelforge.features.engines import store, types as engine_types
from rtxmodelforge.features.build import downloader, engine_builder, types as build_types
...
def run(config: build_types.BuildConfig) -> Path:
    ...
    try:
        ...
        metadata = engine_types.EngineMetadata(
            ...
            vram_used_gb=config.gpu_info.vram_total_gb - config.gpu_info.vram_free_gb, # Estimativa real de uso
