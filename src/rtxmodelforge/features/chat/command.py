...
def chat(
    ...
    system_prompt: Annotated[
        str, 
        typer.Option("--system", help="Instrução inicial do sistema.")
    ] = "Você é um assistente prestativo e especializado em hardware NVIDIA.",
    max_tokens: Annotated[
        int, 
        typer.Option("--max-tokens", help="Máximo de novos tokens por resposta.")
    ] = 512,
) -> None:
    ...
    try:
        ...
        error_console.print("[bold red]✘ Dependências ausentes (tensorrt_llm ou transformers).[/bold red]")
        raise typer.Exit(1)
    ...
    try:
        ...
        console.print("\n[bold blue]Chat Iniciado![/bold blue] Digite [bold magenta]/exit[/bold magenta] para sair ou [bold magenta]/clear[/bold magenta] para reiniciar.\n")
